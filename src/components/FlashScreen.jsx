        ...
        >
            <div className=" flex justify-center flex-col items-center h-dvh w-full relative bg-black">
                ...
                <div className="bg-white z-10 px-2 py-[80px]">
                    ...
                    <img src={LogoMain} alt="logo" className="w-[110px] mx-auto" />

                    <Countdown />
                    <p className="lg:text-7xl sm:text-6xl min-[440px]:text-5xl text-4xl  z-10 text-[#f89e32] px-3 myFont font-bold red-shadow py-" style={{ animation: "fadeInUpLimit 0.8s ease-out" }}>
